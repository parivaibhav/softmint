...
const posts = [
  {
    ...
    excerpt:
      "Discover the latest updates, tips, and stories from the SoftMint team.",
    date: "2024-06-01",
  ...
  },
  {
    ...
    excerpt:
      "A behind-the-scenes look at our tech stack and development process.",
    date: "2024-06-02",
  ...
  },
  {
    ...
    excerpt:
      "Our top recommendations for creating delightful user experiences.",
    date: "2024-06-03",
      ...
      <section className="relative py-8 mb-16 bg-transparent rounded-3xl overflow-hidden shadow-none flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Insights, stories, and updates from the SoftMint team.
          </p>
        </div>
      </section>
          ...
          >
            ...
            <div className="flex-1 flex flex-col p-8">
              <h2 className="text-2xl font-bold mb-2 text-gray-900 group-hover:text-blue-600 transition-colors">
                <Link href={`/user/blog/${post.slug}`}>{post.title}</Link>
              </h2>
              ...
              <Link
                ...
                className="mt-4 inline-block text-blue-600 font-semibold hover:underline transition-colors"
              >
                Read More →
              </Link>
            </div>
