...
export default function AdminBlog() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <AdminHeader />
      <div className="flex-1 max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-0 overflow-hidden border border-gray-100">
          {loading ? (
